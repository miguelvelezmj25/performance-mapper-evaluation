 ...
 */
  @featureHouse.FeatureAnnotation(name="Extract")
 ...
 * If the previous entry wasn't closed, this method will close it.
 */
  @featureHouse.FeatureAnnotation(name="DerivativeExtractCRC")
...
@featureHouse.FeatureSwitchID(id=22, thenFeature="DerivativeExtractCRC", elseFeature="Extract")
public ZipEntry
getNextEntry() throws IOException {
    if (verificationClasses.FeatureSwitches.__SELECTED_FEATURE_DerivativeExtractCRC) {
 ...
 */
   @featureHouse.FeatureAnnotation(name="featureSwitch")
@featureHouse.FeatureSwitchID(id=23, thenFeature="DerivativeExtractCRC", elseFeature="Extract")
public void
...
protected void  hook36__role__DerivativeExtractCRC() throws IOException {
   ...
   @featureHouse.FeatureAnnotation(name="featureSwitch")
@featureHouse.FeatureSwitchID(id=24, thenFeature="DerivativeExtractCRC", elseFeature="Extract")
protected void
...
protected void  hook37__role__DerivativeExtractCRC(  byte[] b,  int off,  int len) throws IOException {
   ...
   @featureHouse.FeatureAnnotation(name="featureSwitch")
@featureHouse.FeatureSwitchID(id=25, thenFeature="DerivativeExtractCRC", elseFeature="Extract")
protected void
...
protected void  hook38__role__DerivativeExtractCRC() throws IOException {
   ...
   @featureHouse.FeatureAnnotation(name="featureSwitch")
@featureHouse.FeatureSwitchID(id=26, thenFeature="DerivativeExtractCRC", elseFeature="Extract")
protected void
...
protected void  hook39__role__DerivativeExtractCRC() throws IOException {
   ...
   @featureHouse.FeatureAnnotation(name="featureSwitch")
@featureHouse.FeatureSwitchID(id=27, thenFeature="DerivativeExtractCRC", elseFeature="Extract")
protected void
...
protected void  hook40__role__DerivativeExtractCRC() throws IOException {
   ...
   @featureHouse.FeatureAnnotation(name="featureSwitch")
@featureHouse.FeatureSwitchID(id=28, thenFeature="DerivativeExtractCRC", elseFeature="Extract")
protected void

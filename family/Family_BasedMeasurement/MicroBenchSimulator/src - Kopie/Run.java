...
private void
dosomething__before__f2Alternative() {
	...
	@featureHouse.FeatureAnnotation(name="f2Alternative")
private void  dosomething__role__f2Alternative() {
		try{
			  //do what you want to do before sleeping
			  Thread.currentThread().sleep(4000);//sleep for 4000 ms
	...
	@featureHouse.FeatureAnnotation (name="featureSwitch")
@featureHouse.FeatureSwitchID(id=4, thenFeature="f2Alternative", elseFeature="featureSwitch")
private void
dosomething__before__f3() {
    if (verificationClasses.FeatureSwitches.__SELECTED_FEATURE_f2Alternative) {
        dosomething__role__f2Alternative();
    } else {
        dosomething__before__f2Alternative();
    }
}
...
private void  dosomething__role__f3() {
	...
	@featureHouse.FeatureAnnotation (name="featureSwitch")
@featureHouse.FeatureSwitchID(id=6, thenFeature="f3", elseFeature="featureSwitch")
private void
...
private void  dosomething__role__f5(){
	...
	@featureHouse.FeatureAnnotation (name="featureSwitch")
@featureHouse.FeatureSwitchID(id=8, thenFeature="f5", elseFeature="featureSwitch")
private void
...
private void  dosomething__role__f8(){
	...
	@featureHouse.FeatureAnnotation(name="featureSwitch")
@featureHouse.FeatureSwitchID(id=13, thenFeature="f8", elseFeature="featureSwitch")
private void
dosomething() {
...
domore__before__f2Alternative() {
	...
	@featureHouse.FeatureAnnotation(name="f2Alternative")
private void  domore__role__f2Alternative()
	{
		try{
	...
	@featureHouse.FeatureAnnotation (name="featureSwitch")
@featureHouse.FeatureSwitchID(id=5, thenFeature="f2Alternative", elseFeature="featureSwitch")
private void
domore__before__f6() {
    if (verificationClasses.FeatureSwitches.__SELECTED_FEATURE_f2Alternative) {
        domore__role__f2Alternative();
    } else {
        domore__before__f2Alternative();
    }
}
...
private void  domore__role__f6(){
	...
	@featureHouse.FeatureAnnotation (name="featureSwitch")
@featureHouse.FeatureSwitchID(id=10, thenFeature="f6", elseFeature="featureSwitch")
private void
domore__before__f10() {
...
private void  domore__role__f10(){
	...
	@featureHouse.FeatureAnnotation(name="featureSwitch")
@featureHouse.FeatureSwitchID(id=16, thenFeature="f10", elseFeature="featureSwitch")
private void
domore() {
...
private void  print__role__f4(){
	...
	@featureHouse.FeatureAnnotation (name="featureSwitch")
@featureHouse.FeatureSwitchID(id=7, thenFeature="f4", elseFeature="base")
private void
print__before__f5() {
...
private void  print__role__f5(){
	...
	@featureHouse.FeatureAnnotation (name="featureSwitch")
@featureHouse.FeatureSwitchID(id=9, thenFeature="f5", elseFeature="featureSwitch")
private void
print__before__f6() {
    if (verificationClasses.FeatureSwitches.__SELECTED_FEATURE_f5) {
        print__role__f5();
...
private void  print__role__f6(){
	...
	@featureHouse.FeatureAnnotation (name="featureSwitch")
@featureHouse.FeatureSwitchID(id=11, thenFeature="f6", elseFeature="featureSwitch")
private void
print__before__f7() {
    if (verificationClasses.FeatureSwitches.__SELECTED_FEATURE_f6) {
        print__role__f6();
...
private void  print__role__f7(){
	...
	@featureHouse.FeatureAnnotation (name="featureSwitch")
@featureHouse.FeatureSwitchID(id=12, thenFeature="f7", elseFeature="featureSwitch")
private void
print__before__f8() {
...
private void  print__role__f8(){
	...
	@featureHouse.FeatureAnnotation (name="featureSwitch")
@featureHouse.FeatureSwitchID(id=14, thenFeature="f8", elseFeature="featureSwitch")
private void
print__before__f9() {
    if (verificationClasses.FeatureSwitches.__SELECTED_FEATURE_f8) {
        print__role__f8();
...
private void  print__role__f9(){
	...
	@featureHouse.FeatureAnnotation (name="featureSwitch")
@featureHouse.FeatureSwitchID(id=15, thenFeature="f9", elseFeature="featureSwitch")
private void
print__before__f10() {
...
private void  print__role__f10(){
	...
	@featureHouse.FeatureAnnotation(name="featureSwitch")
@featureHouse.FeatureSwitchID(id=17, thenFeature="f10", elseFeature="featureSwitch")
private void
print() {
    if (verificationClasses.FeatureSwitches.__SELECTED_FEATURE_f10) {
        print__role__f10();

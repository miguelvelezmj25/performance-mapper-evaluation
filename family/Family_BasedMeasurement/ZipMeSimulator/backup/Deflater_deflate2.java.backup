...
@featureHouse.FeatureSwitchID(id=33, thenFeature="DerivativeCompressAdler32Checksum", elseFeature="Compress")
protected void
hook22() {
...
protected void  hook23__role__DerivativeCompressAdler32Checksum(){
   ...
   @featureHouse.FeatureAnnotation(name="featureSwitch")
@featureHouse.FeatureSwitchID(id=34, thenFeature="DerivativeCompressAdler32Checksum", elseFeature="Compress")
protected void
hook23() {
    if (verificationClasses.FeatureSwitches.__SELECTED_FEATURE_DerivativeCompressAdler32Checksum) {

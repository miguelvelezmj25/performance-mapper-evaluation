...
import net.sf.zipme.ZipEntry; import net.sf.zipme.GZIPInputStream; 
import net.sf.zipme.GZIPOutputStream; 
...
public    class   ZipTest {
	...
	@featureHouse.FeatureAnnotation (name="ZipMeTest")
...
@featureHouse.FeatureSwitchID(id=1, thenFeature="GZIP", elseFeature="ZipMeTest")
private static DeflaterOutputStream
getZipOutStream(OutputStream out, File forFile) throws IOException {
    if (verificationClasses.FeatureSwitches.__SELECTED_FEATURE_GZIP) {
...
private static InflaterInputStream  getZipInStream__role__GZIP(InputStream in) throws IOException {
	...
	@featureHouse.FeatureAnnotation(name="featureSwitch")
@featureHouse.FeatureSwitchID(id=2, thenFeature="GZIP", elseFeature="ZipMeTest")

...
@featureHouse.FeatureSwitchID(id=9, thenFeature="Compress", elseFeature="Base")
public void
reset() {
    if (verificationClasses.FeatureSwitches.__SELECTED_FEATURE_Compress) {
 ...
 */
   @featureHouse.FeatureAnnotation(name="featureSwitch")
@featureHouse.FeatureSwitchID(id=10, thenFeature="Compress", elseFeature="Base")
public void
end() {
    if (verificationClasses.FeatureSwitches.__SELECTED_FEATURE_Compress) {
        end__role__Compress();
...
protected void  hook24__role__Compress(  int lvl){
   ...
   @featureHouse.FeatureAnnotation(name="featureSwitch")
@featureHouse.FeatureSwitchID(id=11, thenFeature="Compress", elseFeature="Base")
protected void
hook24(  int lvl) {
    if (verificationClasses.FeatureSwitches.__SELECTED_FEATURE_Compress) {
...
protected void  hook25__role__Compress(){
   ...
   @featureHouse.FeatureAnnotation(name="featureSwitch")
@featureHouse.FeatureSwitchID(id=12, thenFeature="Compress", elseFeature="Base")
protected void
hook25() {
    if (verificationClasses.FeatureSwitches.__SELECTED_FEATURE_Compress) {

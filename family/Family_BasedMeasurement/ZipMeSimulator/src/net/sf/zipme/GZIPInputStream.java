...
class  GZIPInputStream  extends InflaterInputStream {
     ...
     */
    @featureHouse.FeatureAnnotation(name="GZIP")
...
public void hook__before__DerivativeGZIPCRC(){
    ...
    @featureHouse.FeatureAnnotation(name="DerivativeGZIPCRC")
...
@featureHouse.FeatureSwitchID(id=13, thenFeature="DerivativeGZIPCRC", elseFeature="GZIP")
public void
hook() {
    if (verificationClasses.FeatureSwitches.__SELECTED_FEATURE_DerivativeGZIPCRC) {
...
public void  hook3__role__DerivativeGZIPCRC(  int crcval) throws IOException {
    ...
    @featureHouse.FeatureAnnotation(name="featureSwitch")
@featureHouse.FeatureSwitchID(id=14, thenFeature="DerivativeGZIPCRC", elseFeature="GZIP")
public void
...
public void  hook2__role__DerivativeGZIPCRC(  int CM){
    ...
    @featureHouse.FeatureAnnotation(name="featureSwitch")
@featureHouse.FeatureSwitchID(id=15, thenFeature="DerivativeGZIPCRC", elseFeature="GZIP")
public void
hook2(  int CM) {
    if (verificationClasses.FeatureSwitches.__SELECTED_FEATURE_DerivativeGZIPCRC) {
...
private void  hook1__role__DerivativeGZIPCRC(){
    ...
    @featureHouse.FeatureAnnotation(name="featureSwitch")
@featureHouse.FeatureSwitchID(id=16, thenFeature="DerivativeGZIPCRC", elseFeature="GZIP")
private void
hook1() {
    if (verificationClasses.FeatureSwitches.__SELECTED_FEATURE_DerivativeGZIPCRC) {
...
public void  hook4__role__DerivativeGZIPCRC(  int crcval) throws IOException {
    ...
    @featureHouse.FeatureAnnotation(name="featureSwitch")
@featureHouse.FeatureSwitchID(id=17, thenFeature="DerivativeGZIPCRC", elseFeature="GZIP")
public void
...
protected void  hook30__role__DerivativeGZIPCRC(  byte[] buf,  int offset,  int numRead) throws IOException {
    ...
    @featureHouse.FeatureAnnotation(name="featureSwitch")
@featureHouse.FeatureSwitchID(id=18, thenFeature="DerivativeGZIPCRC", elseFeature="GZIP")
protected void

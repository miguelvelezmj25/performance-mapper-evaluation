 ...
 */
  ...
  @featureHouse.FeatureAnnotation(name="Compress")
...
@featureHouse.FeatureAnnotation(name="DerivativeCompressAdler32Checksum")
...
@featureHouse.FeatureSwitchID(id=29, thenFeature="DerivativeCompressAdler32Checksum", elseFeature="Compress")
protected void
hook26() {
    if (verificationClasses.FeatureSwitches.__SELECTED_FEATURE_DerivativeCompressAdler32Checksum) {
...
protected void  hook27__role__DerivativeCompressAdler32Checksum(){
   ...
   @featureHouse.FeatureAnnotation(name="featureSwitch")
@featureHouse.FeatureSwitchID(id=30, thenFeature="DerivativeCompressAdler32Checksum", elseFeature="Compress")
protected void
hook27() {
    if (verificationClasses.FeatureSwitches.__SELECTED_FEATURE_DerivativeCompressAdler32Checksum) {
...
protected void  hook28__role__DerivativeCompressAdler32Checksum(  int more){
   ...
   @featureHouse.FeatureAnnotation(name="featureSwitch")
@featureHouse.FeatureSwitchID(id=31, thenFeature="DerivativeCompressAdler32Checksum", elseFeature="Compress")
protected void
hook28(int more) {
    if (verificationClasses.FeatureSwitches.__SELECTED_FEATURE_DerivativeCompressAdler32Checksum) {
...
protected void  hook29__role__DerivativeCompressAdler32Checksum(  byte[] buffer,  int offset,  int length){
   ...
   @featureHouse.FeatureAnnotation(name="featureSwitch")
@featureHouse.FeatureSwitchID(id=32, thenFeature="DerivativeCompressAdler32Checksum", elseFeature="Compress")
protected void

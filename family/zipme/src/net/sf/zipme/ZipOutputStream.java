...
protected void hook41__before__DerivativeCompressCRC() throws IOException {
 ...
 @featureHouse.FeatureAnnotation(name="DerivativeCompressCRC")
...
@featureHouse.FeatureSwitchID(id=19, thenFeature="DerivativeCompressCRC", elseFeature="Compress")
protected void
hook41() throws IOException {
    if (verificationClasses.FeatureSwitches.__SELECTED_FEATURE_DerivativeCompressCRC) {
...
protected void  hook42__role__DerivativeCompressCRC() throws IOException {
   ...
   @featureHouse.FeatureAnnotation(name="featureSwitch")
@featureHouse.FeatureSwitchID(id=20, thenFeature="DerivativeCompressCRC", elseFeature="Compress")
protected void
...
protected void  hook43__role__DerivativeCompressCRC(  byte[] b,  int off,  int len) throws IOException {
   ...
   @featureHouse.FeatureAnnotation(name="featureSwitch")
@featureHouse.FeatureSwitchID(id=21, thenFeature="DerivativeCompressCRC", elseFeature="Compress")
protected void

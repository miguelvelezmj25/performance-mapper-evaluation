...
public 
class  ZipArchive  implements ZipConstants {
...
public void hook1__before__ArchiveCheck() throws ZipException {
  ...
  @featureHouse.FeatureAnnotation(name="ArchiveCheck")
...
@featureHouse.FeatureSwitchID(id=0, thenFeature="ArchiveCheck", elseFeature="Base")
public void
hook1() throws ZipException {
    if (verificationClasses.FeatureSwitches.__SELECTED_FEATURE_ArchiveCheck) {

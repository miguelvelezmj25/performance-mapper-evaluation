...
public class Run {
  ...
  private static final String HELP =
      "java -jar pngtastic-x.x.jar com.googlecode.pngtastic.PngtasticColorCounter [options] file1 [file2 ..]\n"
          + "Options:\n"
  ...
  public static void main(String[] args) {
    ...
    files[0] =
        System.getProperty("user.home")
            ...
            //
            //
            // "/Documents/Programming/Java/Projects/performance-mapper-evaluation/phosphor/pngtastic-counter/images/optimizer/us.png";
            "/Documents/Programming/Java/Projects/performance-mapper-evaluation/phosphor/pngtastic-counter/images/optimizer/lena.png";
    ...
    //        Double distThreshold = safeDouble(options.get("--distThreshold"), 0.005D);  // min
    // @8bit: 0.000005
    ...
    // CC + PHOSPHOR
    FREQTHRESHOLD = Sources.FREQTHRESHOLD_0(Boolean.valueOf(args[0]));
    DISTTHRESHOLD = Sources.DISTTHRESHOLD_1(Boolean.valueOf(args[1]));
    MINALPHA = Sources.MINALPHA_2(Boolean.valueOf(args[2]));
    TIMEOUT = Sources.TIMEOUT_3(Boolean.valueOf(args[3]));
    LOGLEVEL = Sources.LOGLEVEL_4(Boolean.valueOf(args[4]));

...
public class PopulateCGDepth {
  ...
  public static void main(String args[]) {
    ...
    DUPLICATES = Sources.getOptionDUPLICATES(Boolean.valueOf(args[3]));
    KEYSIZE = Sources.getOptionKEYSIZE(Boolean.valueOf(args[4]));
    SEQUENTIAL = Sources.getOptionSEQUENTIAL(Boolean.valueOf(args[5]));

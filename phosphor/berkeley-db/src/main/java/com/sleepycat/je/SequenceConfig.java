...
public class SequenceConfig implements Cloneable {
    ...
    /**
     * Configures the {@link Database#openSequence
     ...
     * Database#openSequence Database.openSequence} method to
    ...
    /**
     * Returns true if the {@link Database#openSequence
     ...
     * application.</p>
     *
     * @return true if the {@link Database#openSequence
     * Database.openSequence} method is configured to create the sequence if it
     * does not already exist.
     */

...
public class DatabaseConfig implements Cloneable {
    ...
    /**
     * Returns true if the {@link Environment#openDatabase
     ...
     * application.</p>
     *
     * @return true if the {@link Environment#openDatabase
     * Environment.openDatabase} method is configured to create the database
     * if it does not already exist.
     */
    ...
    /**
     * Configure the {@link Environment#openDatabase

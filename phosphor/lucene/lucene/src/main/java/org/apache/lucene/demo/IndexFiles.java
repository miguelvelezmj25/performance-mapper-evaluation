...
import org.apache.lucene.core.document.LongPoint;
import org.apache.lucene.core.document.StringField;
import org.apache.lucene.core.document.TextField;
...
//        MERGE_SCHEDULER = Sources.MERGE_SCHEDULER_0(Boolean.parseBoolean(args[0]));
        CHECK_PENDING_FLUSH_UPDATE = Sources.CHECK_PENDING_FLUSH_UPDATE_0(Boolean.parseBoolean(args[0]));
        MAX_BUFFERED_DOCS = Sources.MAX_BUFFERED_DOCS_1(Boolean.parseBoolean(args[1]));
//        MERGE_POLICY = Sources.MERGE_POLICY_2(Boolean.parseBoolean(args[2]));
        READER_POOLING = Sources.READER_POOLING_2(Boolean.parseBoolean(args[2]));

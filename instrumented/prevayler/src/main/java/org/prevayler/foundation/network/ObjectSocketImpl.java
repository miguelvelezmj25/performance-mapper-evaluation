...
// This is free software. It is distributed in the hope that it will be useful, but WITHOUT ANY
// WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR
// PURPOSE. See the license distributed along with this file for more details.
  ...
  public ObjectSocketImpl(Socket socket) throws IOException {
    ...
    _outputStream =
        new ObjectOutputStream(
            _socket
                .getOutputStream()); // Get the OUTPUT stream first. JDK 1.3.1_01 for Windows will
                                     // lock up if you get the INPUT stream first.

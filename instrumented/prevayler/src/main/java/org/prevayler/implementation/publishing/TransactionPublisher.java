...
public interface TransactionPublisher {
  ...
  /**
   * Updates the given subscriber with all transactions published since initialTransaction, returns
   * and continues publishing all future transactions to him.
   */
  ...
  /**
   * Publishes transaction to the subscribers synchronously. This method will only return after all
   * subscribers have received transaction. Note that no guarantee can be made as to wether the
   * subscribers have actually executed it.
   */

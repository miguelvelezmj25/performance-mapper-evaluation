...
public class PngtasticColorCounter {
  ...
  public PngtasticColorCounter(
    ...
    PngColorCounter counter =
        new PngColorCounter(logLevel, distThreshold, freqThreshold, minAlpha, timeout);
    ...
    System.out.println(
        String.format("Processed in %d milliseconds", System.currentTimeMillis() - start));
  }
  ...
  //        files = new String[1];
  //        files[0] =
  // "/Users/mvelezce/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/pngtastic/images/optimizer/1px.png";
  //

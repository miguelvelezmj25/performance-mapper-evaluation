  ...
  public static void main(String[] args) {
    ...
    files[0] =
        System.getProperty("user.home")
            ...
            //
            //
            // "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/pngtastic-counter/images/optimizer/us.png";
            "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/pngtastic-counter/images/optimizer/lena.png";
    ...
    // CC + PHOSPHOR
    FREQTHRESHOLD = Source.FREQTHRESHOLD_0(Boolean.valueOf(args[0]));
    DISTTHRESHOLD = Source.DISTTHRESHOLD_1(Boolean.valueOf(args[1]));
    MINALPHA = Source.MINALPHA_2(Boolean.valueOf(args[2]));
    TIMEOUT = Source.TIMEOUT_3(Boolean.valueOf(args[3]));
    LOGLEVEL = Source.LOGLEVEL_4(Boolean.valueOf(args[4]));

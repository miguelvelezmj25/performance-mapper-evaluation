package org.unix4j.sort.processor;
...
public interface InputProcessor {
     ...
     *
     * @param input  the input device whose lines are about to be processed next
     ...
     *
     * @param input  the input device, the source of the given {@code line}
     ...
     *
     * @param input  the input device whose lines have now all been processed
     * @param output the output to write to
     */

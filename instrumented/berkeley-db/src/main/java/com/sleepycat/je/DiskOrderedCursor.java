...
public class DiskOrderedCursor implements ForwardCursor {
     ...
     * null, {@link LockMode#DEFAULT} or
     * {@link LockMode#READ_UNCOMMITTED}, and no locking
     * is performed.
     */
    @Override
     ...
     * parameter must be either null, {@link LockMode#DEFAULT}
     * or {@link LockMode#READ_UNCOMMITTED}, and no locking
     * is performed.
     *
     * @return {@link OperationStatus#KEYEMPTY
     * OperationStatus.KEYEMPTY} if there are no more records in the
     * DiskOrderedCursor set, otherwise, {@link
     * OperationStatus#SUCCESS OperationStatus.SUCCESS}.  If

...
public class Sources implements TaintedWithObjTag {
  ...
  public static long JECACHESIZE_4(boolean option) {
  ...
  public static boolean SHAREDCACHE_6(boolean option) {
    return option;
  }

  public static boolean REPLICATED_7(boolean option) {
    return option;
  }
  ...
  public static TaintedLongWithObjTag JECACHESIZE_4$$PHOSPHORTAGGED(
      Taint originalTag, boolean option, ControlTaintTagStack ctrl, TaintedLongWithObjTag ret) {
    ret.val = JECACHESIZE_4(option);
  ...
  public static TaintedBooleanWithObjTag SHAREDCACHE_6$$PHOSPHORTAGGED(
      Taint originalTag, boolean option, ControlTaintTagStack ctrl, TaintedBooleanWithObjTag ret) {
    ret.val = option;
  ...
  public static TaintedBooleanWithObjTag REPLICATED_7$$PHOSPHORTAGGED(
      Taint originalTag, boolean option, ControlTaintTagStack ctrl, TaintedBooleanWithObjTag ret) {
    ret.val = option;

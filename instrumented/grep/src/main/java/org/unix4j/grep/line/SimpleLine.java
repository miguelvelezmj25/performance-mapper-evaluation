...
public class SimpleLine implements Line {
     ...
     *
     * @param content the character sequence containing the {@link #getContent()
     ...
     * @param content    the character sequence containing the {@link #getContent()
     *                   content} data of the line
     * @param lineEnding a single line ending character
     * @throws IllegalArgumentException if {@code lineEnding} contains more than two characters
     * @throws NullPointerException     if {@code content} or {@code LineEvent} is null
     */
     ...
     * @param content    the character sequence containing the {@link #getContent()
     *                   content} data of the line
     * @param lineEnding the character sequence containing the {@link #getLineEnding()

...
public class VerifyConfig implements Cloneable {
    ...
    /**
     * Configures {@link Environment#verify
     * Environment.verify} and {@link Database#verify
     ...
     * Environment#verify Environment.verify} and {@link
     * Database#verify Database.verify} to propagate
    ...
    /**
     * Returns true if the {@link Environment#verify
     * Environment.verify} and {@link Database#verify
     ...
     * application.</p>
     *
     * @return true if the {@link Environment#verify
     * Environment.verify} and {@link Database#verify
     * Database.verify} are configured to propagate exceptions found during
     * verification.
     */
     ...
     * Environment#verify Environment.verify} and {@link
     * Database#verify Database.verify} to perform fine
     ...
     * Environment#verify Environment.verify} and {@link
     * Database#verify Database.verify} to print basic

...
public class EnvironmentConfig extends EnvironmentMutableConfig {
     ...
     * setting MAX_MEMORY to a non-zero value overrides the percentage based
     * calculation and sets the cache size explicitly.</p>
     *
     ...
     * changing these parameters will change the size of the shared cache.</p>
     *
     * <p>When using the shared cache feature, new environments that join the

package org.unix4j.sort.util.sort;

import org.unix4j.sort.util.StringUtil;
...
public class TrimBlanksStringComparator implements Comparator<String> {
     ...
     *
     * @param mode       the mode defining which end of the character sequence should
     *                   be trimmed
     * @param comparator delegate comparator performing the actual comparison after
     *                   trimming
     */

...
public class SubscriptionRecord implements org.fusesource.hawtbuf.proto.PBMessageFactory<SubscriptionRecord.Bean, SubscriptionRecord.Buffer> {
   ...
   public interface Getter extends org.fusesource.hawtbuf.proto.PBMessage<SubscriptionRecord.Bean, SubscriptionRecord.Buffer> {
      ...
      public java.lang.String getSubscribedDestinationName();
      public Bean copy();
   ...
   static public final class Bean implements Getter {
      ...
      // optional string subscribed_destination_name = 6;
      private java.lang.String f_subscribedDestinationName = null;

      public boolean hasSubscribedDestinationName() {
         return bean.f_subscribedDestinationName!=null;
      }

      public java.lang.String getSubscribedDestinationName() {
         return bean.f_subscribedDestinationName;
      }

      public Bean setSubscribedDestinationName(java.lang.String subscribedDestinationName) {
         copyCheck();
      ...
      public java.lang.StringBuilder toString(java.lang.StringBuilder sb, String prefix) {
         ...
         if(  hasSubscribedDestinationName() ) {
            sb.append(prefix+"subscribed_destination_name: ");
            sb.append(getSubscribedDestinationName());
            sb.append("\n");
         }
         return sb;
      }
      ...
      public Bean mergeUnframed(org.fusesource.hawtbuf.proto.CodedInputStream input) throws java.io.IOException {
         ...
         while (true) {
            ...
            case 42:
               ...
               break;
            case 50:
               setSubscribedDestinationName(input.readString());
               break;
            }
         }
      }
      ...
      public boolean equals(Bean obj) {
         ...
         if (hasDestinationName() && ( !getDestinationName().equals(obj.getDestinationName()) ))
            return false;
         if (hasSubscribedDestinationName() ^ obj.hasSubscribedDestinationName() ) 
            return false;
         if (hasSubscribedDestinationName() && ( !getSubscribedDestinationName().equals(obj.getSubscribedDestinationName()) ))
            return false;
         return true;
      }
      ...
      public int hashCode() {
         ...
         if (hasSubscribedDestinationName()) {
            rc ^= ( -924694561^getSubscribedDestinationName().hashCode() );
         }
         return rc;
      }
      ...
      public Bean mergeFrom(Getter other) {
         ...
         if (other.hasSubscribedDestinationName()) {
            setSubscribedDestinationName(other.getSubscribedDestinationName());
         }
         return this;
      }
      ...
      public void clear() {
         ...
         clearSubscribedDestinationName();
      }
      ...
      public void readExternal(java.io.DataInput in) throws java.io.IOException {
         ...
         if( in.readBoolean() ) {
            f_subscribedDestinationName = in.readUTF();
         } else {
            f_subscribedDestinationName = null;
         }
      }
      ...
      public void writeExternal(java.io.DataOutput out) throws java.io.IOException {
         ...
         if( bean.f_subscribedDestinationName!=null ) {
            out.writeBoolean(true);
            out.writeUTF(bean.f_subscribedDestinationName);
         } else {
            out.writeBoolean(false);
         }
      }
   ...
   static public final class Buffer implements org.fusesource.hawtbuf.proto.MessageBuffer<SubscriptionRecord.Bean, SubscriptionRecord.Buffer>, Getter {
      ...
      // optional string subscribed_destination_name = 6;
      public boolean hasSubscribedDestinationName() {
         return bean().hasSubscribedDestinationName();
      }

      public java.lang.String getSubscribedDestinationName() {
         return bean().getSubscribedDestinationName();
      }
      ...
      public void writeUnframed(org.fusesource.hawtbuf.proto.CodedOutputStream output) throws java.io.IOException {
         if (buffer == null) {
            ...
            if (bean.hasSubscribedDestinationName()) {
               output.writeString(6, bean.getSubscribedDestinationName());
            }
            if( original !=null ) {
      ...
      public int serializedSizeUnframed() {
         ...
         if (hasSubscribedDestinationName()) {
            size += org.fusesource.hawtbuf.proto.CodedOutputStream.computeStringSize(6, getSubscribedDestinationName());
         }
         return size;
      }

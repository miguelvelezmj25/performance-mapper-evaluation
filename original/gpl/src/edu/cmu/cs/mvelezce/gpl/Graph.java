...
//			theNewPred.adjustAdorns( theVertex, j );
    ...
    public Graph Kruskal() {
        ...
        for (i = 0; i < numedges; i++) {
            ...
            if (!(v.representative.name).equals(u.representative.name)) {
                ...
                if ((urep.members).size() > (vrep.members).size()) { // we add elements of v to u
    ...
    public void run(Vertex s) {
        if (SHORTEST) {
            ...
            Graph.stopProfile();
            Main.splPrint___("******************************************");
            Main.splPrint___("<SHORTEST graph>");
            gaux3.display();
            Graph.resumeProfile();
        }
        if (MSTKRUSKAL) {
            ...
            Graph.stopProfile();
            Main.splPrint___("******************************************");
            Main.splPrint___("<MSTKRUSKAL graph>");
            gaux2.display();
            Graph.resumeProfile();
        }
        if (MSTPRIM) {
            ...
            Graph.stopProfile();
            Main.splPrint___("******************************************");
            Main.splPrint___("<MSTPRIM graph>");
            gaux.display();
            Graph.resumeProfile();
        }
        if (CYCLE) {
            ...
            Main.splPrint___("******************************************");
            Graph.stopProfile();
            Main.splPrint___("<CYCLE>: " + CycleCheck());
            Graph.resumeProfile();
        }
        if (STRONGLYCONNECTED) {
            ...
            Graph.stopProfile();
            Main.splPrint___("******************************************");
            Main.splPrint___("<STRONGLYCONNECTED graph>");
            gaux4.display();
            Graph.resumeProfile();
        }
        if (CONNECTED) {
...
//		edu.cmu.cs.mvelezce.Main.splPrint___("Time elapsed: " + accum);
    }
}

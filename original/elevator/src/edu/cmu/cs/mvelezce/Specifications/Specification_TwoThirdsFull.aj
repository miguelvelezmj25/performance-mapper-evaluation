...
public privileged aspect Specification_TwoThirdsFull extends AbstractSpecification {
    ...
    pointcut continueInDirection(Elevator e): execution(private void edu.cmu.cs.mvelezce.ElevatorSystem.Elevator.continueInDirection(edu.cmu.cs.mvelezce.ElevatorSystem.Elevator.Direction)) && target(e);

...
import static org.rauschig.jarchivelib.ArchiveFormat.*;
import static org.rauschig.jarchivelib.CompressionType.*;
...
public final class FileType {
    ...
    public static FileType get(String filename) {
        for(Map.Entry<String, FileType> entry : MAP.entrySet()) {
            if(Sink.getDecision(filename.toLowerCase().endsWith(entry.getKey()))) {

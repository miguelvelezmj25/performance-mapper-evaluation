...
class Counters {
     ...
     * set in {@code args}.
     *
     * @param args the arguments with the options indicating which counts are
     *             desired
     */
     ...
     *
     * @param line the line to incorporate into the counts
     */
     ...
     * counter.
     *
     * @param counters the counters with per-file counts
     */
     ...
     *
     * @param output   the output destination
     * @param fileInfo the file information, usually a file name or path
     */
     ...
     * @param output                      the output destination
     * @param fileInfo                    the file information, usually a file name or path
     * @param fixedWidthOfColumnsInOutput the fixed width of the outputted counts.  Will usually be the width

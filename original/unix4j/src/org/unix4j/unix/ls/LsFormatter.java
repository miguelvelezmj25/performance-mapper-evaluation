...
interface LsFormatter {
     ...
     *
     * @param relativeTo the starting directory to use as starting point to get to
     *                   {@code file}; all path elements from this directory to
     *                   {@code file} should be printed
     * @param file       the file whose name or other information is written to
     *                   {@code output}
     * @param args       arguments possibly used to lookup some formatting options
    ...
    interface Factory {
         ...
         *                       printed
         * @param directory      the directory whose files should be formatted
         * @param directoryFiles the directory files to be formatted by the returned
         *                       formatter
         * @param args           arguments possibly used to lookup some formatting options
         */

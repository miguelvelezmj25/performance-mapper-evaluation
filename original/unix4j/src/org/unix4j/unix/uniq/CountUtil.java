...
class CountUtil {
     ...
     * @param countDigits the number of digits to use, padding the given value with
     ...
     * @param count       the count written before the line
     * @param countDigits the number of digits to use for {@code <count>}, padding the
     *                    given value with spaces from left if necessary
     * @param output      the output device to write to

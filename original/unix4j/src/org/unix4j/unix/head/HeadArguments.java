 ...
 */
public final class HeadArguments implements Arguments<HeadArguments> {
    ...
    /**
     * Returns the {@code <count>} operand value: The first {@code count} lines of each input file are
    ...
    /**
     * Sets {@code <count>}: The first {@code count} lines of each input file are
     * copied to standard output, starting from 1 (characters instead of
     * lines if the {@code -c} option is specified). Must be a non-negative
     * integer or an exception is thrown. If {@code count} is greater than
     * the number number of lines (characters) in the input, the
    ...
    /**
     * Returns true if the {@code --}{@link HeadOption#chars chars} option
    ...
    public boolean isChars() {
        return getOptions().isSet(HeadOption.chars);
    }

    /**
     * Returns true if the {@code --}{@link HeadOption#suppressHeaders suppressHeaders} option
    ...
    public boolean isSuppressHeaders() {
        return getOptions().isSet(HeadOption.suppressHeaders);
    }

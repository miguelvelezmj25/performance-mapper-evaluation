...
public class BlockCompressor implements Runnable, Callable<Integer> {
    ...
    public BlockCompressor(int verbose, boolean force, int blockSize, int level, String entropy, String transform,
                           boolean checksum, int jobs, Map<String, Object> map, ExecutorService threadPool) {
        this.level = level;

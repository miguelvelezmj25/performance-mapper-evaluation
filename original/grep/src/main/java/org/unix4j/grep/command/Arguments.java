 ...
 *
 * @param <A> the concrete command specific arguments type
 */
public interface Arguments<A extends Arguments<A>> {
     ...
     *
     * @param context the execution context providing access to variables and
     *                converters
     * @return an arguments object with resolved variables where possible
     * @throws NullPointerException     if context is null
     * @throws IllegalArgumentException if variables are defined but cannot be converted into the
     *                                  target type
     */

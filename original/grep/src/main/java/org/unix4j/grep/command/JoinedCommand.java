package org.unix4j.grep.command;
...
public class JoinedCommand<A extends Arguments<A>> implements Command<A> {
     ...
     *
     * @param first  the first command in the join, whose output is joined to the
     *               input of the second command
     * @param second the second command in the join, whose input is joined from the
     *               output of the first command
     * @throws NullPointerException if any of the command arguments is null
     */
     ...
     *
     * @param context context object providing access to the current directory,
     *                environment variables and other information useful for the
     *                commands during their execution
     * @param output  the output for the second command
     */
    @Override

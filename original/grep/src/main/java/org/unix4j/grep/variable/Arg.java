package org.unix4j.grep.variable;
...
public class Arg {
     ...
     *
     * @param expression the potential variable name to check
     ...
     * {@link #arg(int)}.
     *
     * @param name the name of the variable, such as "$0", "$1" etc.
     ...
     *
     * @param name the name of the variable, such as "$@+1", "$@+3" etc.
     * @return the index of the argument referenced by the variable, for
     ...
     *
     * @param index zero based index of first argument in the args list

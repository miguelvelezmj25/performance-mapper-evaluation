...
//     */
//    @Override
//    Unix4jCommandBuilder cut(CutOptions options, org.unix4j.grep.util.Range range);
//
//    /**
...
//     */
//    @Override
//    Unix4jCommandBuilder cut(CutOptions options, String delimiter, org.unix4j.grep.util.Range range);
//
//    /**
...
//     */
//    @Override
//    Unix4jCommandBuilder cut(CutOptions options, String delimiter, char outputDelimiter, org.unix4j.grep.util.Range range);
//
//    /**
...
//     */
//    @Override
//    Unix4jCommandBuilder from(org.unix4j.grep.io.Input input);
...
//     */
//    @Override
//    Unix4jCommandBuilder sort(java.util.Comparator<? super org.unix4j.grep.line.Line> comparator);
//
//    /**
//     * Sort the lines of all the specified files together and writes the
//     * result to the standard output.
...
//     */
//    @Override
//    Unix4jCommandBuilder sort(java.util.Comparator<? super org.unix4j.grep.line.Line> comparator, java.io.File... files);
//
//    /**
//     * Sort the lines of all the specified files together and writes the
//     * result to the standard output.
...
//     */
//    @Override
//    Unix4jCommandBuilder sort(java.util.Comparator<? super org.unix4j.grep.line.Line> comparator, String... paths);
//
//    /**
...
//     */
//    @Override
//    Unix4jCommandBuilder sort(SortOptions options, java.util.Comparator<? super org.unix4j.grep.line.Line> comparator);
//
//    /**
//     * Sorts, merges, or sequence checks the lines the lines of all the
//     * specified files together and writes the result to the standard
...
//     */
//    @Override
//    Unix4jCommandBuilder sort(SortOptions options, java.util.Comparator<? super org.unix4j.grep.line.Line> comparator, java.io.File... files);
//
//    /**
//     * Sorts, merges, or sequence checks the lines the lines of all the
//     * specified files together and writes the result to the standard
...
//     */
//    @Override
//    Unix4jCommandBuilder sort(SortOptions options, java.util.Comparator<? super org.unix4j.grep.line.Line> comparator, String... paths);
//
//	/* ------------------ tail ------------------ */
//
//    /**

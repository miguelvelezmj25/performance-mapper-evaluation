 ...
 *
 * @param <A> the type parameter defining the arguments and options of the
 *            command
 */
public interface Command<A extends Arguments<A>> {
     ...
     *
     * @param context the execution context with access to variables and value
     ...
     * of as input.
     *
     * @param next the next command to join to this command

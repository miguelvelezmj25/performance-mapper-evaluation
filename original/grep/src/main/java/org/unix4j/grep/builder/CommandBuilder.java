...
public interface CommandBuilder extends To {
     ...
     *
     * @param command the command to join the last previously joined command
     * @return the builder for chained method invocation to join other commands
     * @throws NullPointerException if the command argument is null
     */
     ...
     * output to the standard input of the specified command.
     *
     * @param operation the operation on which the added command is based
     * @return the builder for chained method invocation to join other commands
     * @throws NullPointerException if the operation argument is null
     */

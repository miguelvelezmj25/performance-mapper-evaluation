...
import org.unix4j.grep.command.CommandInterface;
...
public class GenericCommandBuilder {
     ...
     *
     * @param <B>                     the generic type of the builder interface to be implemented by
     *                                the returned builder
     * @param commandBuilderInterface the class representing the builder interface to be implemented
     *                                by the returned builder
     * @param commandFactories        the factories containing a factory method for every command
     *                                method in the given builder interface
     * @return a new builder instance implementing the specified interface
     * @throws IllegalArgumentException if {@code commandBuilderInterface} is not an interface class,
     ...
     * @param commandBuilderInterface the class representing the builder interface to be implemented
     *                                by the returned builder
     * @param defaultCommandBuilder   the default builder with implementations for all non-command
     *                                specific methods
     * @param commandFactories        the factories containing a factory method for every command
     *                                method in the given builder interface
     * @return a new builder instance implementing the specified interface
    ...
    private static class GenericCommandHandler<B extends CommandBuilder> implements InvocationHandler {
        ...
        public GenericCommandHandler(Class<B> commandBuilderInterface, DefaultCommandBuilder defaultCommandBuilder, CommandInterface<? extends Command<?>>... commandFactories) {
            ...
            final Map<MethodSignature, Object> factoryMethods = new HashMap<MethodSignature, Object>();

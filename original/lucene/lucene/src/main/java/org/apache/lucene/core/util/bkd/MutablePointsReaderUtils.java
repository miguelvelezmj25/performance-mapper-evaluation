...
import org.apache.lucene.core.util.IntroSelector;
import org.apache.lucene.core.util.IntroSorter;
import org.apache.lucene.core.util.MSBRadixSorter;
import org.apache.lucene.core.util.RadixSelector;
import org.apache.lucene.core.util.Selector;
...
public final class MutablePointsReaderUtils {
  ...
  public static void sort(int maxDoc, int packedBytesLength,
    ...
    new MSBRadixSorter(packedBytesLength + (bitsPerDocId + 7) / 8) {
      ...
      @Override
      protected org.apache.lucene.core.util.Sorter getFallbackSorter(int k) {

...
public class TestDemo extends LuceneTestCase {
  ...
  public void testIndexSearch() throws Exception {
    File dir =
        new File(
            "/Users/mvelezce/Documents/Programming/Java/Projects/performance-mapper-evaluation/original/lucene/demo/src/test/java/org/apache/lucene/demo/test-files/docs");
    File indexDir = new File("ContribDemoTest");
    indexDir.delete();
    indexDir.mkdir();
    IndexFiles.main(
        new String[] {"-create", "-docs", dir.toString(), "-index", indexDir.toString()});

    Path indexDirPath = indexDir.toPath();
    testOneSearch(indexDirPath, "apache", 3);
    testOneSearch(indexDirPath, "patent", 8);
    testOneSearch(indexDirPath, "lucene", 0);
    testOneSearch(indexDirPath, "gnu", 6);
    testOneSearch(indexDirPath, "derivative", 8);
    testOneSearch(indexDirPath, "license", 13);
  }
}

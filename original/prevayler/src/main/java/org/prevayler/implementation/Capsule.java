...
public abstract class Capsule implements Serializable {
  ...
  protected Capsule(
      Object transaction, Serializer journalSerializer, boolean transactionDeepCopyMode) {
  ...
  /**
   * Gets the serialized representation of the transaction. Callers must not modify the returned
   * array.
   */
  ...
  /**
   * Executes a freshly deserialized copy of the transaction by default. If <code>
   * configureTransactionDeepCopy</code> was set to <code>true</code> on your <code>PrevaylerFactory
   * </code>, this will execute the transaction directly. The execution will synchronize on the
   * prevalentSystem.
   */
  ...
  /**
   * Actually executes the Transaction or TransactionWithQuery. The caller is responsible for
   * synchronizing on the prevalentSystem.
   */
  protected abstract void justExecute(
      Object transaction, Object prevalentSystem, Date executionTime);

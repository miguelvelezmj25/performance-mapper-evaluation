...
public class ServerListener extends Thread {
  ...
  // TODO Close the socket when the publisher is closed (listen for it or have the Dashboard (new
  // idea) close this when it closes the publisher).

  public ServerListener(TransactionPublisher publisher, OldNetworkImpl network, int port)
      throws IOException {

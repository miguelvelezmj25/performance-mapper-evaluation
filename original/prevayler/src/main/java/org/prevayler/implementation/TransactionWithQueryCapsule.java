...
class TransactionWithQueryCapsule<P, R> extends Capsule {
  ...
  public TransactionWithQueryCapsule(
      TransactionWithQuery<? super P, R> transactionWithQuery,
  ...
  protected void justExecute(Object transaction, Object prevalentSystem, Date executionTime) {
    try {
      _queryResult =
          ((TransactionWithQuery<P, R>) transaction)
              .executeAndQuery((P) prevalentSystem, executionTime);

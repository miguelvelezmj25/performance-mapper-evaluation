...
public class ClientPublisher implements TransactionPublisher {
  ...
  public ClientPublisher(OldNetworkImpl network, String serverIpAddress, int serverPort)
      throws IOException {
  ...
  private void receiveTransactionFromServer() throws IOException, ClassNotFoundException {
    ...
    _subscriber.receive(
        new TransactionTimestamp(transactionTimestamp.capsule(), systemVersion, timestamp));
  }

 ...
 */
public class MVTemporaryDbStress {
    ...
    private String numCleanerThreads = "1";
    ...
    private volatile int totalOps = 50000;
    ...
    public static void main(String args[]) {
        try {
            MVTemporaryDbStress test = new MVTemporaryDbStress();

            List<String> argsList = new ArrayList<>();
            argsList.add("-h");
            argsList.add(test.envHome);
            argsList.add("-cacheSize");
            argsList.add(test.cacheSize + "");
            argsList.add("-dataSize");
            argsList.add(test.dataSize + "");
            argsList.add("-dbSize");
            argsList.add(test.dbSize + "");
            argsList.add("-threads");
            argsList.add(test.numThreads + "");
            argsList.add("-cleanerThreads");
            argsList.add(test.numCleanerThreads);
            argsList.add("-totalOps");
            argsList.add(test.totalOps + "");
            argsList.add("-subDir");
            argsList.add(test.subDir + "");

...
public abstract class ReplicationNetworkConfig
     ...
     */
    /**
     * @hidden A string identifying a class to instantiate as the data channel
    ...
    /**
     * @hidden A string providing factory-specific data channel configuration
    ...
    /**
     * @hidden Ensure that the parameters for this and all known derived classes are
     ...
     * @hidden Apply the configurations specified in sourceProps to updateProps,
     ...
     * @hidden Returns name of the DataChannel factory class to be used for creating
     ...
     * @return this
     * @hidden Sets the name of the DataChannelFactory class to be instantiated for
     ...
     * @hidden Returns the DataChannelFactory class parameters to be used for when
     ...
     * @return this
     * @hidden Sets the DataChannelFactory parameters to be passed when instantiating

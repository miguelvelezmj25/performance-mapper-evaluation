...
public class Utils {
    ...
    /**
     * @hidden A utility wrapper to handle all exceptions from futures in a consistent
     * way. The above method illustrates its intended usage pattern
     */
    public static abstract class WithFutureExceptionHandler<T extends MessageExchange> {
    ...
    /**
     * @hidden A subclass of ExecutorCompletionService that tracks submitted tasks, so

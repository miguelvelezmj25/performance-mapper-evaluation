...
/**
 * @hidden A notification callback interface to warn the user that JE is about to
...
public interface LogFileRewriteListener {
     ...
     * @hidden Notifies the user that JE is about to modify previously written log
     * files.
     */

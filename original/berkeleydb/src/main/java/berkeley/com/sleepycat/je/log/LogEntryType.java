...
import berkeley.com.sleepycat.je.log.entry.AbortLogEntry;
import berkeley.com.sleepycat.je.log.entry.BINDeltaLogEntry;
import berkeley.com.sleepycat.je.log.entry.CommitLogEntry;
import berkeley.com.sleepycat.je.log.entry.DeletedDupLNLogEntry;
...
import berkeley.com.sleepycat.je.log.entry.MatchpointLogEntry;
...
public class LogEntryType {
    ...
    public static final LogEntryType LOG_OLD_LN_TRANSACTIONAL =
        createReplicableLogEntryType(
            (byte) 1, "LN_TX",
            LNLogEntry.create(berkeley.com.sleepycat.je.tree.LN.class),
            Txnal.TXNAL,
    ...
    public static final LogEntryType LOG_MAPLN_TRANSACTIONAL =
        new LogEntryType
        ((byte) 3, "MapLN_TX",
         LNLogEntry.create(berkeley.com.sleepycat.je.tree.MapLN.class),
         Txnal.TXNAL,
    ...
    public static final LogEntryType LOG_DUPCOUNTLN_TRANSACTIONAL =
        ...
        ((byte) 9, "DupCountLN_TX",
         LNLogEntry.create(berkeley.com.sleepycat.je.tree.dupConvert.DupCountLN.class),
         Txnal.TXNAL,
         Marshall.OUTSIDE_LATCH,
         NodeType.OLD_DUP);
    ...
    public static final LogEntryType LOG_FILESUMMARYLN =
        ...
        ((byte) 11, "FileSummaryLN",
         LNLogEntry.create(berkeley.com.sleepycat.je.tree.FileSummaryLN.class),
         Txnal.NON_TXNAL,
         Marshall.INSIDE_LATCH,
         NodeType.LN_INTERNAL);
    ...
    public static final LogEntryType LOG_IN =
        new LogEntryType
        ((byte) 12, "IN",
         INLogEntry.create(berkeley.com.sleepycat.je.tree.IN.class),
         Txnal.NON_TXNAL,
         Marshall.OUTSIDE_LATCH,
         NodeType.IN);
    ...
    public static final LogEntryType LOG_BIN =
        new LogEntryType
        ((byte) 13, "BIN",
         INLogEntry.create(berkeley.com.sleepycat.je.tree.BIN.class),
         Txnal.NON_TXNAL,
         Marshall.OUTSIDE_LATCH,
         NodeType.IN);
    ...
    public static final LogEntryType LOG_DIN =
        new LogEntryType
        ((byte) 14, "DIN",
         INLogEntry.create(berkeley.com.sleepycat.je.tree.dupConvert.DIN.class),
         Txnal.NON_TXNAL,
         Marshall.OUTSIDE_LATCH,
         NodeType.OLD_DUP);
    ...
    public static final LogEntryType LOG_DBIN =
        new LogEntryType
        ((byte) 15, "DBIN",
         INLogEntry.create(berkeley.com.sleepycat.je.tree.dupConvert.DBIN.class),
         Txnal.NON_TXNAL,
         Marshall.OUTSIDE_LATCH,
         NodeType.OLD_DUP);
    ...
    public static final LogEntryType LOG_DBTREE =
        ...
        ((byte) 16, "DbTree",
         SingleItemEntry.create(
             berkeley.com.sleepycat.je.dbi.DbTree.class),
         Txnal.NON_TXNAL,
         Marshall.INSIDE_LATCH,
         NodeType.NONE);
    ...
    public static final LogEntryType LOG_CKPT_START =
        ...
        ((byte) 19, "CkptStart",
         SingleItemEntry.create(
             berkeley.com.sleepycat.je.recovery.CheckpointStart.class),
         Txnal.NON_TXNAL,
         Marshall.OUTSIDE_LATCH,
         NodeType.NONE);
    ...
    public static final LogEntryType LOG_CKPT_END =
        ...
        ((byte) 20, "CkptEnd",
         SingleItemEntry.create(
             berkeley.com.sleepycat.je.recovery.CheckpointEnd.class),
         Txnal.NON_TXNAL,
         Marshall.OUTSIDE_LATCH,
         NodeType.NONE);
    ...
    public static final LogEntryType LOG_IN_DELETE_INFO =
        ...
        ((byte) 21, "INDelete",
         SingleItemEntry.create(
             berkeley.com.sleepycat.je.tree.dupConvert.INDeleteInfo.class),
         Txnal.NON_TXNAL,
         Marshall.OUTSIDE_LATCH,
         NodeType.NONE);
    ...
    public static final LogEntryType LOG_OLD_BIN_DELTA =
        ...
        ((byte) 22, "BINDelta",
         ...
         (berkeley.com.sleepycat.je.tree.OldBINDelta.class),
         Txnal.NON_TXNAL,
         Marshall.OUTSIDE_LATCH,
         NodeType.NONE);
    ...
    public static final LogEntryType LOG_FILE_HEADER =
        ...
        ((byte) 25, "FileHeader",
         new FileHeaderEntry
         (berkeley.com.sleepycat.je.log.FileHeader.class),
         Txnal.NON_TXNAL,
         Marshall.OUTSIDE_LATCH,
         NodeType.NONE);
    ...
    public static final LogEntryType LOG_IN_DUPDELETE_INFO =
        ...
        ((byte) 26, "INDupDelete",
         SingleItemEntry.create(
             berkeley.com.sleepycat.je.tree.dupConvert.INDupDeleteInfo.class),
         Txnal.NON_TXNAL,
         Marshall.OUTSIDE_LATCH,
         NodeType.NONE);
    ...
    public static final LogEntryType LOG_TXN_PREPARE =
        ...
        ((byte) 27, "Prepare",
         SingleItemEntry.create(
             berkeley.com.sleepycat.je.txn.TxnPrepare.class),
         Txnal.TXNAL,
         Marshall.OUTSIDE_LATCH,
         NodeType.NONE);
    ...
    public static final LogEntryType LOG_ROLLBACK_START =
        ...
        ((byte) 28, "RollbackStart",
         SingleItemEntry.create(
             berkeley.com.sleepycat.je.txn.RollbackStart.class),
         Txnal.NON_TXNAL,
         Marshall.OUTSIDE_LATCH,
         NodeType.NONE);
    ...
    public static final LogEntryType LOG_ROLLBACK_END =
        ...
        ((byte) 29, "RollbackEnd",
         SingleItemEntry.create(
             berkeley.com.sleepycat.je.txn.RollbackEnd.class),
         Txnal.NON_TXNAL,
         Marshall.OUTSIDE_LATCH,
         NodeType.NONE);
    ...
    public static final LogEntryType LOG_BIN_DELTA =
        new LogEntryType(
            (byte) 37, "NewBINDelta",
            new BINDeltaLogEntry(berkeley.com.sleepycat.je.tree.BIN.class),
            Txnal.NON_TXNAL,
            Marshall.OUTSIDE_LATCH,
            NodeType.IN);
    ...
    public static final LogEntryType LOG_IMMUTABLE_FILE =
        new LogEntryType(
            ...
            SingleItemEntry.create(
                berkeley.com.sleepycat.je.log.entry.EmptyLogEntry.class),
            Txnal.NON_TXNAL,
            Marshall.OUTSIDE_LATCH,
            NodeType.NONE);
    ...
    public static final LogEntryType LOG_RESTORE_REQUIRED =
        new LogEntryType(
            ...
            SingleItemEntry.create(
                berkeley.com.sleepycat.je.log.entry.RestoreRequired.class),
            Txnal.NON_TXNAL,
            Marshall.OUTSIDE_LATCH,
            NodeType.NONE);

...
import berkeley.com.sleepycat.je.config.*;
import berkeley.com.sleepycat.je.rep.*;
import berkeley.com.sleepycat.je.rep.util.DbResetRepGroup;
import berkeley.com.sleepycat.je.rep.utilint.RepUtils;
import berkeley.com.sleepycat.je.rep.utilint.net.SSLChannelFactory;
...
public class RepParams {
    ...
    /**
     * @hidden Name of a java System property (boolean) which can be turned on in order
    ...
    public static final DurationConfigParam REP_STREAM_TIMEOUT =
            new DurationConfigParam(ReplicationConfig.REP_STREAM_TIMEOUT,
                    ...
                    true);
    /**
     * @deprecated It's retained primarily for compatibility and should not be used by new

...
public class EnvironmentFailureException extends RunRecoveryException {
     ...
     * @hidden Promotes the given cause exception and message to an
     ...
     * For internal use only.
     *
     * @hidden Creates an exception indicating that an unexpected exception was caught
     ...
     * For internal use only.
     *
     * @hidden Creates an exception indicating that unexpected internal state was
     ...
     * For internal use only.
     *
     * @hidden Convenience method that throws an UNEXPECTED_STATE exception (non-fatal)
     ...
     * For internal use only.
     *
     * @hidden Must be overridden by every concrete subclass to return an instance of
     ...
     * For internal use only.
     *
     * @hidden Remember that this was already thrown. That way, if we re-throw it

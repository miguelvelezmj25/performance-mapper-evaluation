...
package org.apache.storm.client.daemon.supervisor;
...
public class ClientSupervisorUtils {
    ...
    public static boolean doRequiredTopoFilesExist(Map<String, Object> conf, String stormId) throws IOException {

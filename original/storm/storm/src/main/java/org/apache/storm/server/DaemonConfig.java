...
import org.apache.storm.server.container.ResourceIsolationInterface;
import org.apache.storm.server.nimbus.ITopologyActionNotifierPlugin;
import org.apache.storm.server.scheduler.blacklist.reporters.IReporter;
import org.apache.storm.server.scheduler.blacklist.strategies.IBlacklistStrategy;
import org.apache.storm.server.scheduler.resource.strategies.priority.ISchedulingPriorityStrategy;
import org.apache.storm.server.scheduler.resource.strategies.scheduling.IStrategy;
import org.apache.storm.client.security.auth.IAuthorizer;
import org.apache.storm.server.security.auth.IHttpCredentialsPlugin;
import org.apache.storm.client.validation.ConfigValidation;
import org.apache.storm.client.validation.Validated;

import static org.apache.storm.client.validation.ConfigValidationAnnotations.NotNull;
import static org.apache.storm.client.validation.ConfigValidationAnnotations.isBoolean;
import static org.apache.storm.client.validation.ConfigValidationAnnotations.isImplementationOfClass;
import static org.apache.storm.client.validation.ConfigValidationAnnotations.isInteger;
import static org.apache.storm.client.validation.ConfigValidationAnnotations.isListEntryCustom;
import static org.apache.storm.client.validation.ConfigValidationAnnotations.isMapEntryCustom;
import static org.apache.storm.client.validation.ConfigValidationAnnotations.isMapEntryType;
import static org.apache.storm.client.validation.ConfigValidationAnnotations.isNoDuplicateInList;
import static org.apache.storm.client.validation.ConfigValidationAnnotations.isNumber;
import static org.apache.storm.client.validation.ConfigValidationAnnotations.isPositiveNumber;
import static org.apache.storm.client.validation.ConfigValidationAnnotations.isString;
import static org.apache.storm.client.validation.ConfigValidationAnnotations.isStringList;
import static org.apache.storm.client.validation.ConfigValidationAnnotations.isStringOrStringList;
import static org.apache.storm.client.validation.ConfigValidationAnnotations.Password;
 ...
 *
 * This class extends {@link org.apache.storm.client.Config} for supporting Storm Daemons.
 */
public class DaemonConfig implements Validated {
     ...
     * org.apache.storm.server.daemon.metrics.reporters.PreparableReporter} interface.
     */
    @isStringList

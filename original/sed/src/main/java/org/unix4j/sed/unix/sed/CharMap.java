...
class CharMap {
     ...
     * @throws IllegalArgumentException if any of the destination characters is the zero character
     */
     ...
     * @throws IllegalArgumentException if the destination character is the zero character
     */

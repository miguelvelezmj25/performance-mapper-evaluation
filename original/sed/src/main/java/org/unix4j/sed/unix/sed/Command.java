...
import org.unix4j.sed.util.StringUtil;
...
public enum Command {
     ...
     *
     * @param string the string with the command chararcter candidates
     * @param start  the start index in string, inclusive
     * @param end    the end index in string, exclusive
     * @return the matching command or null if not found
     */
     ...
     *
     * @param args the sed command arguments
     * @return the matching command or null if not found
     */
     ...
     *
     * @param args   the sed arguments passed to the processor constructor
     * @param output the output object passed to the processor constructor
     ...
     *
     * @param script the sed script passed to the processor constructor
     * @param args   the sed arguments passed to the processor constructor
     * @param output the output object passed to the processor constructor
     * @return a new sed processor instance for this command
     */

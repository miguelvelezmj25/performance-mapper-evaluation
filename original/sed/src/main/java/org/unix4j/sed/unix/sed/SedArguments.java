...
public final class SedArguments {
    ...
    public SedArguments(boolean quiet, boolean global, boolean print, boolean lineNumber, boolean ignoreCase, boolean substitute, boolean append, boolean insert, boolean change, boolean delete, boolean translate) {
        this.quiet = quiet;
        this.global = global;
        this.print = print;

...
//        InputStream in = getClass().getResourceAsStream("test.properties");
        InputStream in = new FileInputStream("/Users/mvelezce/Documents/Programming/Java/Projects/performance-mapper-evaluation/original/h2-db/src/test/java/org/h2/test/bench/test.properties");
        prop.load(in);
        in.close();

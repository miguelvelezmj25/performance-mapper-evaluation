...
public interface VariableContext extends VariableResolver {
     ...
     * @param converter a converter suitable to convert values into the target type
     *                  {@code <V>}
     * @return the converted value, or null if the variable does not exist
     * @throws IllegalArgumentException if the value conversion fails, that is, if the converter

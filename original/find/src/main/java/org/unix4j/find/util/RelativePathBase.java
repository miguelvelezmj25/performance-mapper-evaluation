...
public class RelativePathBase {
     ...
     *
     * @param base the basis for relative paths returned by
     ...
     * @param base     the basis for relative paths returned by
     *                 {@link #getRelativePathFor(File)}
     * @param settings the settings used to construct relative paths
     */
     ...
     * </ol>
     *
     * @param file the target file whose relative path is returned
    ...
    public static interface Settings {
         ...
         *
         * @param result  the string builder with the result path
         * @param baseDir the base directory, here also the relative path target
         ...
         *
         * @param result  the string builder with the result path
         * @param baseDir the base directory, here a parent directory of the
         ...
         *
         * @param result  the string builder with the result path
         * @param baseDir the base directory, here a directory which has a common

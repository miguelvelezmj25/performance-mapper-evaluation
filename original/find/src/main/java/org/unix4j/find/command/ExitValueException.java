package org.unix4j.find.command;

import org.unix4j.find.io.FileInput;
import org.unix4j.find.io.Input;
...
public class ExitValueException extends RuntimeException {
     ...
     * @param exitValue the exit value, must be different from zero
     * @throws IllegalArgumentException if {@code exitValue==0}
     */
     ...
     * @param message   the error message
     * @param exitValue the exit value, must be different from zero
     * @param cause     the exception that caused the error termination of the command
     * @throws IllegalArgumentException if {@code exitValue==0}
     */
     ...
     *
     * @param input the input source or file that was causing the exception
     */

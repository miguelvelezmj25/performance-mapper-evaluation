...
import org.unix4j.find.line.SingleCharSequenceLine;
...
public class StringUtil {
     ...
     * </ul>
     *
     * @param size      the fixed size of the returned string
     * @param alignLeft true if {@code value} should be left-aligned
     * @param filler    the filler character if {@code value} is shorter than
     *                  {@code size}
     ...
     * @param size      the fixed size of the returned string
     * @param alignLeft true if {@code value} should be left-aligned
     * @param filler    the filler character if {@code s} is shorter than {@code size}
     * @param s         the string to format
     * @return the string {@code s} as a fixed size string, padded or truncated
     * if necessary
     */
     ...
     *
     * @param s     the character sequence
     * @param start the first index to consider in the char sequence
     * @return the index containing the first non-whitespace character, or the
     * length of the character sequence if all characters are blank
     */
     ...
     * @param source   the characters being searched.
     * @param target   the characters being searched for.
     * @param maxIndex the maximum index to return (for instance 0 if only the start

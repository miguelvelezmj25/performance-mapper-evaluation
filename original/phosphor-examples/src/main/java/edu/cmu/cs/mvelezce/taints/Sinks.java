...
//  static final long serialVersionUID = 6758243016172226215L;
...
//  }
//
//  public static void sink$$PHOSPHORTAGGED(Taint var0, int var1, ControlTaintTagStack var2) {
//    Configuration.autoTainter.checkTaint(var0, "edu/cmu/cs/mvelezce/taints/Sinks.sink$$PHOSPHORTAGGED(Ledu/columbia/cs/psl/phosphor/runtime/Taint;ILedu/columbia/cs/psl/phosphor/struct/ControlTaintTagStack;)V");
//    Configuration.autoTainter.checkTaint(var2, "edu/cmu/cs/mvelezce/taints/Sinks.sink$$PHOSPHORTAGGED(Ledu/columbia/cs/psl/phosphor/runtime/Taint;ILedu/columbia/cs/psl/phosphor/struct/ControlTaintTagStack;)V");
//  }
//
...
//  }
//
//  public static void sink$$PHOSPHORTAGGED(Taint t, ControlTaintTagStack PhopshorImplicitTaintTrackingFromParent) {
//      Configuration.autoTainter.checkTaint(t, "edu/cmu/cs/mvelezce/taints/Sinks.sink$$PHOSPHORTAGGED(Ljava/lang/Object;Ledu/columbia/cs/psl/phosphor/struct/ControlTaintTagStack;)V");
//      Configuration.autoTainter.checkTaint(PhopshorImplicitTaintTrackingFromParent, "edu/cmu/cs/mvelezce/taints/Sinks.sink$$PHOSPHORTAGGED(Ljava/lang/Object;Ledu/columbia/cs/psl/phosphor/struct/ControlTaintTagStack;)V");
//  }
//
...
//    sink$$PHOSPHORTAGGED((Taint)null, i, ControlTaintTagStack.getInstance());
//  }
//
//  public static void sink(Object o) {
...
//    sink$$PHOSPHORTAGGED(t, ControlTaintTagStack.getInstance());
//  }
//

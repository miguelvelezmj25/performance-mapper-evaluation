 ...
 * call like this:
 *
 * <p><code>String encoded = Base64.encodeBytes(mybytes, Base64.GZIP | Base64.DO_BREAK_LINES);
 * </code>
 *
...
class Base64 {
   ...
   * <p>
   *
   * <p>As of v 2.3, if there is a error, the method will throw an IOException. <b>This is new to
  ...
  public static byte[] decodeFromFile(String filename) throws IOException {
    ...
    try {
      ...
      // Open a stream
      bis =
          new Base64.InputStream(new BufferedInputStream(new FileInputStream(file)), Base64.DECODE);
  ...
  public static String encodeFromFile(String filename) throws IOException {
    ...
    try {
      ...
      // Open a stream
      bis =
          new Base64.InputStream(new BufferedInputStream(new FileInputStream(file)), Base64.ENCODE);

...
public final class GrepArguments {
    ...
    private BooleanSupplier isInvertMatch;
    private BooleanSupplier isFixedStrings;
    private BooleanSupplier isLineNumber;
    private BooleanSupplier isCount;
    private BooleanSupplier isMatchingFiles;
    private BooleanSupplier isWholeLine;
...
//    private final GrepOptions options;
     ...
     * @param isIgnoreCase
     * @param isInvertMatch
     * @param isFixedStrings
     * @param isLineNumber
     * @param isCount
     * @param isMatchingFiles
     * @param isWholeLine
     */
...
//    }
    public GrepArguments(BooleanSupplier isIgnoreCase, BooleanSupplier isInvertMatch, BooleanSupplier isFixedStrings, BooleanSupplier isLineNumber,
                         BooleanSupplier isCount, BooleanSupplier isMatchingFiles, BooleanSupplier isWholeLine) {
...
//    }
    ...
    public boolean isIgnoreCase() {
        return this.isIgnoreCase.getAsBoolean();
    }
...
//    }
    ...
    public boolean isInvertMatch() {
        return this.isInvertMatch.getAsBoolean();
    }
...
//    }
    ...
    public boolean isFixedStrings() {
        return this.isFixedStrings.getAsBoolean();
    }
...
//    }
    ...
    public boolean isLineNumber() {
        return this.isLineNumber.getAsBoolean();
    }
...
//    }
    ...
    public boolean isCount() {
        return this.isCount.getAsBoolean();
    }
...
//    }
    ...
    public boolean isMatchingFiles() {
        return this.isMatchingFiles.getAsBoolean();
    }
...
//    }
    ...
    public boolean isWholeLine() {
        return this.isWholeLine.getAsBoolean();
    }

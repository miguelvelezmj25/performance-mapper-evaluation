...
public class SingleCharSequenceLine implements Line {
     ...
     *
     * @param charSequence     the character sequence containing the data
     * @param lineEndingLength the number of characters making up the line ending; must be
     *                         one or two
     * @throws IllegalArgumentException if {@code lineEndingLength} is negative or larger than two
     */
     ...
     *
     * @param charSequence     the character sequence containing the data
     * @param offset           the offset containing the first character of line
     * @param contentLength    the number of characters making up the content of the line
     *                         without line ending; must be non-negative
     * @param lineEndingLength the number of characters making up the line ending; must be
     *                         zero, one or two (zero only for the last line)
     * @throws IllegalArgumentException  if {@code offset} or {@code contentLength} are negative or
     *                                   {@code lineEndingLength} is negative or larger than two
     * @throws IndexOutOfBoundsException if the buffer length is smaller than

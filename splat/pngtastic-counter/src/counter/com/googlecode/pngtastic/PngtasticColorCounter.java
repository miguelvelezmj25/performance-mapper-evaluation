...
public class PngtasticColorCounter {
    ...
    public PngtasticColorCounter(String[] fileNames, Supplier<String> logLevel, DoubleSupplier distThreshold, DoubleSupplier freqThreshold,
                                 IntSupplier minAlpha, IntSupplier timeout) {

...
import optimizer.com.googlecode.pngtastic.core.processing.zopfli.Options;
import optimizer.com.googlecode.pngtastic.core.processing.zopfli.Zopfli;
...
public class ZopfliCompressionHandler implements PngCompressionHandler {
    ...
    public ZopfliCompressionHandler(Logger log, IntSupplier iterations) {
        this.log = log;

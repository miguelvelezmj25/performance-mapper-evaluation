...
import optimizer.com.googlecode.pngtastic.core.PngException;
import optimizer.com.googlecode.pngtastic.core.PngImage;
import optimizer.com.googlecode.pngtastic.core.PngOptimizer;
...
//
//    /** */
    public PngtasticOptimizer(String toDir, String[] fileNames, String fileSuffix, BooleanSupplier removeGamma,
                              IntSupplier compressionLevel, Supplier<String> compressor, IntSupplier iterations, Supplier<String> logLevel) {

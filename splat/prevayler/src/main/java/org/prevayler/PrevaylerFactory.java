...
public class PrevaylerFactory<P> {
    ...
    private Supplier<Clock> _clock;
    private BooleanSupplier _transactionDeepCopyMode = () -> true;
    private BooleanSupplier _transientMode;
    private String _prevalenceDirectory;
    private NullSnapshotManager<P> _nullSnapshotManager;
    private LongSupplier _journalSizeThreshold;
    private LongSupplier _journalAgeThreshold;
    private BooleanSupplier _journalDiskSync = () -> true;
    private int _serverPort = -1;
    private String _remoteServerIpAddress;
    private int _remoteServerPort;
    private Supplier<Monitor> _monitor;
     ...
     */
    public void configureTransactionDeepCopy(BooleanSupplier transactionDeepCopyMode) {
     ...
     * @param clock
     */
    public void configureClock(Supplier<Clock> clock) {
        _clock = clock;
    }
     ...
     */
    public void configureMonitor(Supplier<Monitor> monitor) {
        _monitor = monitor;
    }
     ...
     */
    public void configureTransientMode(BooleanSupplier transientMode) {
     ...
     * @param sizeInBytes
     */
    public void configureJournalFileSizeThreshold(LongSupplier sizeInBytes) {
     ...
     * @param ageInMilliseconds
     */
    public void configureJournalFileAgeThreshold(LongSupplier ageInMilliseconds) {
     ...
     */
    public void configureJournalDiskSync(BooleanSupplier journalDiskSync) {
...
//        }
    ...
    private Journal journal() throws IOException {
        if(_transientMode.getAsBoolean()) {

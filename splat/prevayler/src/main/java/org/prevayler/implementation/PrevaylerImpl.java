...
public class PrevaylerImpl<P> implements Prevayler<P> {
    ...
    private BooleanSupplier _transactionDeepCopyMode;
    ...
    public PrevaylerImpl(GenericSnapshotManager<P> snapshotManager, TransactionPublisher transactionPublisher,
                         Serializer journalSerializer, BooleanSupplier transactionDeepCopyMode) throws IOException, ClassNotFoundException {

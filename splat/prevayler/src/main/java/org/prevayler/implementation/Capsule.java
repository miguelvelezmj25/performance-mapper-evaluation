...
public abstract class Capsule implements Serializable {
    ...
    protected Capsule(Object transaction, Serializer journalSerializer, BooleanSupplier transactionDeepCopyMode) {
        if(transactionDeepCopyMode.getAsBoolean() == false) {

...
public final class PostProcessorUtil {
    ...
    public static Result runImageOptimizer(File rawFile, ImageType processedType, String[] args, BooleanSupplier keepOriginal) throws IOException {
        return runImageOptimizer(rawFile, processedType, args, keepOriginal, MiscUtil.getFileExtension(rawFile));
    }

    public static Result runImageOptimizer(File rawFile, ImageType processedType, String[] args, BooleanSupplier keepOriginal, String outExtension) throws IOException {

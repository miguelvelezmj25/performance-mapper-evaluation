...
public class DConvert {
    ...
    public void execute(Arguments args, boolean blockingWaitForFinish, HandlerCallback callback) {
        ...
        if (!args.filesToProcess.isEmpty()) {
            ...
            for (EPlatform ePlatform : args.platform.get()) {
            ...
            if (args.clearDirBeforeConvert.getAsBoolean()) {
            ...
            if (args.enablePngCrush.getAsBoolean()) {
            ...
            if (args.postConvertWebp.getAsBoolean()) {
            ...
            if (args.enableMozJpeg.getAsBoolean()) {

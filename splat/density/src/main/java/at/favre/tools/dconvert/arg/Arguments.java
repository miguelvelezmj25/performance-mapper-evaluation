...
//            false, false, false, false, false, false, false, false, false, false, false, false, null, false, false);
    ...
    public final IntSupplier scale;
    public final Supplier<Set<EPlatform>> platform;
    public final Supplier<EOutputCompressionMode> outputCompressionMode;
    public final Supplier<EScaleMode> scaleMode;
    public final Supplier<EScalingAlgorithm> downScalingAlgorithm;
    public final Supplier<EScalingAlgorithm> upScalingAlgorithm;
    public final Supplier<Float> compressionQuality;
    public final int threadCount;
    public final BooleanSupplier skipExistingFiles;
    public final BooleanSupplier skipUpscaling;
    public final BooleanSupplier verboseLog;
    public final BooleanSupplier includeAndroidLdpiTvdpi;
    public final BooleanSupplier haltOnError;
    public final BooleanSupplier createMipMapInsteadOfDrawableDir;
    public final BooleanSupplier enablePngCrush;
    public final BooleanSupplier enableMozJpeg;
    public final BooleanSupplier postConvertWebp;
    public final BooleanSupplier enableAntiAliasing;
    public final BooleanSupplier dryRun;
    public final BooleanSupplier keepUnoptimizedFilesPostProcessor;
    public final Supplier<RoundingHandler.Strategy> roundingHandler;
    public final BooleanSupplier iosCreateImagesetFolders;
    public final BooleanSupplier guiAdvancedOptions;
    public final BooleanSupplier clearDirBeforeConvert;
    public final transient List<File> filesToProcess;
    public final BooleanSupplier scaleIsHeightdp;

    public Arguments(File src, File dst, IntSupplier scale, Supplier<Set<EPlatform>> platform, Supplier<EOutputCompressionMode> outputCompressionMode,
                     Supplier<EScaleMode> scaleMode, Supplier<EScalingAlgorithm> downScalingAlgorithm, Supplier<EScalingAlgorithm> upScalingAlgorithm, Supplier<Float> compressionQuality, int threadCount, BooleanSupplier skipExistingFiles,
                     BooleanSupplier skipUpscaling,
                     BooleanSupplier verboseLog, BooleanSupplier includeAndroidLdpiTvdpi, BooleanSupplier haltOnError,
                     BooleanSupplier createMipMapInsteadOfDrawableDir,
                     BooleanSupplier iosCreateImagesetFolders, BooleanSupplier enablePngCrush, BooleanSupplier enableMozJpeg, BooleanSupplier postConvertWebp, BooleanSupplier enableAntiAliasing, BooleanSupplier dryRun,
                     BooleanSupplier keepUnoptimizedFilesPostProcessor, Supplier<RoundingHandler.Strategy> roundingHandler,
                     BooleanSupplier guiAdvancedOptions, BooleanSupplier clearDirBeforeConvert, BooleanSupplier scaleIsHeightdp) {
        this.dst = dst;
        this.src = src;
        this.scale = scale;
        ...
        this.scaleIsHeightdp = scaleIsHeightdp;
...
//
//        if(Float.compare(arguments.scale, scale) != 0) {
//            return false;
//        }
//        if(Float.compare(arguments.compressionQuality, compressionQuality) != 0) {
//            return false;
//        }
//        if(threadCount != arguments.threadCount) {
//            return false;
//        }
//        if(skipExistingFiles != arguments.skipExistingFiles) {
//            return false;
//        }
//        if(skipUpscaling != arguments.skipUpscaling) {
//            return false;
//        }
//        if(verboseLog != arguments.verboseLog) {
//            return false;
//        }
//        if(includeAndroidLdpiTvdpi != arguments.includeAndroidLdpiTvdpi) {
//            return false;
//        }
//        if(haltOnError != arguments.haltOnError) {
//            return false;
//        }
//        if(createMipMapInsteadOfDrawableDir != arguments.createMipMapInsteadOfDrawableDir) {
//            return false;
//        }
//        if(enablePngCrush != arguments.enablePngCrush) {
//            return false;
//        }
//        if(enableMozJpeg != arguments.enableMozJpeg) {
//            return false;
//        }
//        if(postConvertWebp != arguments.postConvertWebp) {
//            return false;
//        }
//        if(enableAntiAliasing != arguments.enableAntiAliasing) {
//            return false;
//        }
...
//            return false;
//        }
//        if(iosCreateImagesetFolders != arguments.iosCreateImagesetFolders) {
//            return false;
//        }
//        if(guiAdvancedOptions != arguments.guiAdvancedOptions) {
//            return false;
//        }
//        if(clearDirBeforeConvert != arguments.clearDirBeforeConvert) {
//            return false;
//        }
//        if(src != null ? !src.equals(arguments.src) : arguments.src != null) {
//            return false;
//        }
//        if(dst != null ? !dst.equals(arguments.dst) : arguments.dst != null) {
//            return false;
//        }
//        if(platform != null ? !platform.equals(arguments.platform) : arguments.platform != null) {
//            return false;
//        }
//        if(outputCompressionMode != arguments.outputCompressionMode) {
//            return false;
//        }
//        if(scaleMode != arguments.scaleMode) {
//            return false;
//        }
//        if(downScalingAlgorithm != arguments.downScalingAlgorithm) {
//            return false;
//        }
//        if(upScalingAlgorithm != arguments.upScalingAlgorithm) {
//            return false;
//        }
//        if(roundingHandler != arguments.roundingHandler) {
//            return false;
//        }
...
//    }
    ...
    public static List<ImageType.ECompression> getOutCompressionForType(Supplier<EOutputCompressionMode> type, ImageType imageType) {

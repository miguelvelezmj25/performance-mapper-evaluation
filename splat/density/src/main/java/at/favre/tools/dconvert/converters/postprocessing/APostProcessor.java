...
public abstract class APostProcessor implements IPostProcessor {
    ...
    @Override
    public Result process(File rawFile, BooleanSupplier keepOriginal) {
        try {
    ...
    /**
     * This is the thread safe version of {@link IPostProcessor#process(File, BooleanSupplier)}
     *
     * @param rawFile
     * @param keepOriginal
     * @return
     */
    protected abstract Result synchronizedProcess(File rawFile, BooleanSupplier keepOriginal);
}

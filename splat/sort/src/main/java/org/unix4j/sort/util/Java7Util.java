...
public class Java7Util {
     ...
     * @param baseClass the base class and superclass of the Java 7 class
     ...
     *
     * @param <T>       the generic type of the base class
     * @param baseClass the base class and superclass of the Java 7 class
     * @return the Java 7 subclass if possible and {@code baseClass} otherwise
     * @throws NullPointerException     if {@code baseClass} is null
     * @throws IllegalArgumentException if the Java 7 class is found but it is not a subclass of
     *                                  {@code baseClass}
     */

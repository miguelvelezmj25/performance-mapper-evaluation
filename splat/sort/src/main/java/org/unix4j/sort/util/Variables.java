...
public class Variables {
     ...
     * @param variables  the variable values with the encoded variable name as key
     * @return the resolved variable if {@code expression} represents a
     * variable, and the unchanged expression otherwise
     * @throws IllegalArgumentException if {@code expression} represents a variable but no value for

package org.unix4j.sort.util;

import org.unix4j.sort.variable.Arg;
...
public class FileUtil {
     ...
     *
     * @param files the files to add to a new list
     ...
     * </ol>
     *
     * @param root the root directory for the relative path
     * @param file the file whose path should be returned
     ...
     * @param file             the file to be returned as absolute file
     ...
     *
     * @param file the file whose path elements should be returned
     ...
     *
     * @param paths the file paths, possibly containing wildcard parts
     ...
     *
     * @param currentDirectory the basis for all relative paths
     * @param paths            the file paths, possibly containing wildcard parts
     * @return the expanded files resolving wildcards
     */
     ...
     *
     * @param name the name or pattern without path
